...
export function readEmbeddingMeta(dataDir) {
...
export function writeEmbeddingMeta(dataDir, dimensions) {
    const meta = {
 ...
 */
export async function checkEmbeddingMeta(config, storage) {
 ...
 */
export async function reembedAll(config, storage, onProgress) {
